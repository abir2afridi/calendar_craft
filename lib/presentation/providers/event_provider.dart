...
final eventsForMonthProvider = FutureProvider.family<List<Event>, DateTime>((ref, month) async {
  return await HiveService.getEventsForMonth(month);
});

final searchResultsProvider = FutureProvider.family<List<Event>, String>((ref, query) async {
